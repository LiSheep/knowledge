  ...
  Markdown = (function(_super) {
    ...
    Markdown.prototype._init = function() {
      ...
      if (typeof this.opts.markdown === "object") {
        $.extend(this.hooks, this.opts.markdown);
      }
      return this.editor.on("keypress", (function(_this) {
        return function(e) {
          var $blockEl, cmdEnd, cmdStart, container, content, hook, match, name, range, testRange, _ref, _results;
          if (!(e.which === 32 || e.which === 13)) {
            return;
          }
          range = _this.editor.selection.getRange();
          container = range != null ? range.commonAncestorContainer : void 0;
          if (!(range && range.collapsed && container && container.nodeType === 3)) {
            return;
          }
